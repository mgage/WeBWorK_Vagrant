Vagrant.configure("2") do |config|
    config.vm.define :webwork do |ww_config|
        ...
        ww_config.vm.synced_folder "webwork2", "/opt/webwork/webwork2",  :mount_options => ['dmode=777','fmode=777']
        ww_config.vm.synced_folder "pg", "/opt/webwork/pg",  :mount_options => ['dmode=777','fmode=777']
    end
end
